...
<html lang="ko">
	<c:import url="../main/header.jsp">
    	<c:param name="pageTitle" value="데이터형태 리스트"/>
    </c:import>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
			...
			<div id="layoutSidenav_content">
				<main class="contents">
					<h2 class="contents-title">데이터형태 리스트</h2>
		...
		<script>
			...
			function board_mod(idx){
				location.href= "/data/data_type_register.do?idx="+ idx;
			}
			function board_list(){
			...
			function search(){
				$("#search_fm").attr("action", "/data/data_type_list.do");
				$("#search_fm").submit();
			}
		</script>
